    ...
    <div className="home-page">
      <section className="section" style={{ paddingTop: '5rem' }}>
        <div className="section-inner" style={{ maxWidth: 900 }}>
          ...
          <h1 className="section-title" style={{ textAlign: 'center' }}>Get CHANCE for your device</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: 1.8, marginBottom: '4rem', textAlign: 'center', maxWidth: 600, margin: '0 auto 4rem' }}>
            Experience native performance and offline CXR inference capabilities with our dedicated desktop and mobile applications.
          </p>
          ...
          <div className="downloads-grid">
            ...
            <div className="download-card">
              ...
              <div className="download-links">
                <a href="https://github.com/Rieko00/CHANCE/releases/download/V1.0.0/CHANCE.V1.0.0.msix" className="btn-primary download-btn">
            ...
            <div className="download-card">
              ...
              <div className="download-links">
                <a href="https://github.com/Rieko00/CHANCE/releases/download/V1.0.0/CHANCE.V1.0.0.apk" className="btn-primary download-btn">
          ...
          <div style={{ marginTop: '5rem', padding: '2rem', background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: 250 }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: 8 }}>
                <ShieldCheck size={20} color="var(--success)" /> Secure & Verified
              </h3>
            ...
            <div style={{ flex: 1, minWidth: 250 }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: 8 }}>
                <Zap size={20} color="var(--nodule-mass)" /> Auto-Updates
              </h3>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.6 }}>
